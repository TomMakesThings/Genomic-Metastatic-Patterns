# Set the CNA file to a format suitable for OncoKB annotation by adding OncoTree codes
...
cna_data$Sample_ID <- row.names(cna_data)

write.table(cna_data, file = "Plot_2/OncoKB/cna_for_oncokb.txt",
